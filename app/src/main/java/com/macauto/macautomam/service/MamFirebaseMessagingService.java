...
import com.macauto.macautomam.MainActivity;
import com.macauto.macautomam.R;

import me.leolin.shortcutbadger.ShortcutBadger;


public class MamFirebaseMessagingService extends FirebaseMessagingService {
    private static final String TAG = MamFirebaseMessagingService.class.getName();
    ...
    public MamFirebaseMessagingService() {
        Log.d(TAG, "MamFirebaseMessagingService init");
    ...
    private void sendNotification(String messageTitle, String messageBody) {
        ...
        String NOTIFICATION_CHANNEL_ID = "Macauto MAM";
