    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                confirmdialog.setTitle(view.getResources().getString(R.string.mam_more_logout_title));
                confirmdialog.setMessage(view.getResources().getString(R.string.mam_more_logout_descrypt));
                confirmdialog.setPositiveButton(view.getResources().getString(R.string.mam_confirm), new DialogInterface.OnClickListener() {
                ...
                confirmdialog.setNegativeButton(view.getResources().getString(R.string.mam_cancel), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
