...
public class GetMessageService extends IntentService {
    ...
    private static final String METHOD_NAME = "Get_EDI_list"; // 方法名稱

    private static final String SOAP_ACTION1 = "http://tempuri.org/Get_EDI_list"; // SOAP_ACTION
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                ...
                if (eventType == XmlPullParser.END_TAG) {
                    ...
                    if (name != null && item != null) {
                        ...
                        switch (name) {
                            case "customer":
                                item.setCustomer(tag_value);
                                break;
                            case "edi_type":
                                item.setEdi_type(tag_value);
                                break;
                            case "interchange_control_id":
                                item.setInterchange_ctrl_id(tag_value);
                                break;
                            case "send_datetime":
                        ...
                        if (name.equals("fxs")) {
                            ...
                            intentData.putExtra("customer", item.getCustomer());
                            intentData.putExtra("edi_type", item.getEdi_type());
                            intentData.putExtra("interchange_control_id", item.getInterchange_ctrl_id());
