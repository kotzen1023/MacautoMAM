...
public class UpdateReadStatusService extends IntentService {
    ...
    private static final String METHOD_NAME = "Update_EDI_Read_Status"; // 方法名稱

    private static final String SOAP_ACTION1 = "http://tempuri.org/Update_EDI_Read_Status"; // SOAP_ACTION
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String edi_type = intent.getStringExtra("EDI_TYPE");
        String interchange_ctrl_id = intent.getStringExtra("INTERCHANGE_CTRL_ID");
        ...
        try {
            ...
            request.addProperty("edi_type", edi_type);
            request.addProperty("interchange_control_id", interchange_ctrl_id);
